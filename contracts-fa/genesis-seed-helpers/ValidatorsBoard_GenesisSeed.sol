...
// واقعی و **بدون هیچ ورودی** پیاده می‌کند — آدرس هر عضو مؤسس هیأت مستقیم پایین همین فایل
...
//   ۱. 🔶 FILL_IN: هر آدرس placeholder پایین را با آدرس واقعی و نهایی همان عضو جایگزین کن،
...
contract ValidatorsBoard_GenesisSeed {
    ...
    // ------------------------------------------------------------------
    // constructor بدون ورودی — اعضای مؤسس هیأت (دقیقاً BOARD_SIZE = ۵ نفر) مستقیم پایین
    // هاردکد شده‌اند.
    // 🔶 FILL_IN: هر آدرس 0x000...000 را با آدرس واقعی و نهایی همان عضو جایگزین کن،
    // پیش از این‌که این فایل جایی دیپلوی شود.
    // ------------------------------------------------------------------
    constructor() {
